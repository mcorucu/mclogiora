...
Current phase: Phase 18, Slice 2, Performance, Accessibility, RTL & WordPress.org Compliance Hardening, complete. Phases 02 through 17 are complete; the current pre-submission version line is v1.0.1. WordPress.org submission remains a separate manual step.
